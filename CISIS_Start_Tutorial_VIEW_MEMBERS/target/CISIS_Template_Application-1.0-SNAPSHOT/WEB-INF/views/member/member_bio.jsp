...
<div>
    <spring:nestedPath path="memberBio">

        <html:form action="memberBioUpdate" method="post">
                ...
                <tr>
                    <td>
                        <label class="alignCenter"  for="homePhone">
                            ...
                            <form:input path="homePhone" size="10" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <label class="alignCenter"  for="dateOfBirth">
                            ...
                            <form:input path="dateOfBirth" size="10" />
                    </td>
                </tr>
